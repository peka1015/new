...
// React-Wrapper um Chart.js https://github.com/jerairrest/react-chartjs-2
...
export default function BalkenDiagramm() {
    useTitle('Balkendiagramm')
    return <Bar data={createData()} width={300} height={150} />
}
